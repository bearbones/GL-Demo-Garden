...
export class TuringPatternsPlugin {
    constructor() {
        this.name = 'Turing Patterns';
    ...
    render(ctx) {
        ...
        gl.uniform2f(gl.getUniformLocation(this.computeProgram, 'u_texelSize'), 1.0 / this.pingPong.width, 1.0 / this.pingPong.height);
        ...
        gl.uniform2f(gl.getUniformLocation(this.computeProgram, 'u_mouse'), this.mousePos[0], 1.0 - this.mousePos[1]);
