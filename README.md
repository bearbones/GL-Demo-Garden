...
| **Stone Break** | Procedural rock fracture via iterative energy-propagation compute | Tap to crack; repeated taps deepen, spiderweb, and extend the network until the slab shatters and falls away |
